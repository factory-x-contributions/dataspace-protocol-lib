...
| org.factoryx.library.dcpvalidation.vaultroottoken    | set the token for authorizing access to the MVD provider vault                          | root                                                   | 
...
| org.factoryx.library.dcpvalidation.cacheupdate.hours | set, after how many hours cached values in dcp validation shall be dropped              | 24 (hours)                                             | 
