...
public interface ContractRecordService {
    ...
    /**
     * Returns the NegotiationRecord, which is associated with the given contract id
     *
     * @param contractId - the id of the required NegotiationRecord
     * @return - the NegotiationRecord if it exists, else null
     */
    NegotiationRecord findByContractId(UUID contractId);
